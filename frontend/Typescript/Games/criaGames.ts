import { API_BASE_URL, fetchWithAuth, Game } from "../api_resolver.js";
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (isUpdateMode) {
        ...
        try {
            ...
            (document.getElementById('platforms') as HTMLInputElement).value = game.platforms;
            (document.getElementById('description') as HTMLTextAreaElement).value = game.description;
            (document.getElementById('release_date') as HTMLInputElement).value = game.release_date;
