...
document.addEventListener('DOMContentLoaded', async () => {
    // --- Get DOM Elements ---
    const gameTitleSpan = document.getElementById('game-title') as HTMLSpanElement;
    const confirmButton = document.getElementById('confirm-delete') as HTMLButtonElement;
    const cancelButton = document.getElementById('cancel-delete') as HTMLAnchorElement;
